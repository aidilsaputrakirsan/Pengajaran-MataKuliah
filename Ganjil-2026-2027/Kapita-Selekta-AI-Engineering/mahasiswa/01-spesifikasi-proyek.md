...
1. **AI dipaksakan.** Persoalan yang lebih baik diselesaikan dengan formulir, basis data, atau satu halaman aturan. Bila jawabannya dapat ditentukan secara pasti, Anda tidak butuh model bahasa.
2. **Tidak dapat dibuktikan salah.** Bila tidak ada cara memeriksa keluaran itu benar atau keliru, tidak ada yang dapat dievaluasi pada Minggu 14.
3. **Tanpa sumber pengetahuan yang dapat Anda akses.** Lapisan RAG mengharuskan Anda memiliki dokumen rujukan yang sah untuk dipakai. Bila dokumennya rahasia atau tidak ada, tema gugur.
...
Bila tema Anda ditolak, Anda punya waktu sampai Minggu 6 untuk menggantinya. Setelah Minggu 6, tema terkunci.
...
| Bahasa keluaran wajib | Indonesia; bila `K` genap, tambah satu mode keluaran ringkas | K ganjil → satu mode |

Angka-angka ini adalah **minimum**, bukan target. Produk yang berhenti tepat di angka minimum masih dapat bernilai sangat baik bila rancangan dan evaluasinya matang.
...
Butir terakhir bukan pengakuan kegagalan. Mahasiswa yang mengaku sistemnya tidak pernah gagal dinilai belum menguji dengan sungguh-sungguh.
...
- [ ] Ada batas jumlah langkah dan penanganan bila batas tercapai
...
- [ ] Kajian risiko: *prompt injection*, kebocoran data, bias, dan dampak bila sistem salah
...
Alasannya bukan ketidakpercayaan, melainkan konsekuensi dari tidak adanya asisten: pada kelas dengan bimbingan terbatas, kerja kelompok cenderung menyembunyikan satu orang yang mengerjakan dan sisanya menumpang. Kelas ini menutup kemungkinan itu dari awal.
